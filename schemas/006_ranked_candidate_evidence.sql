...
CREATE TABLE IF NOT EXISTS critical_moves (
    ...
    pv_uci TEXT,
    pv_san TEXT,
    best_continuation_summary TEXT,
    played_continuation_summary TEXT,
    only_move_status TEXT,
    only_move_margin_cp INTEGER,
    candidate_moves_json TEXT,
    candidate_ranking_summary TEXT,
    stronger_alternative_count INTEGER,
